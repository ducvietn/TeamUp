...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Panel - Branding */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-800 via-primary-700 to-primary-600 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          <div className="flex items-center gap-4 mb-12">
            <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center shadow-2xl shadow-indigo-900/30">
          ...
          <h2 className="text-white text-3xl font-bold leading-tight mb-4">
            Tham gia cùng<br />
            <span className="text-primary-200">hàng trăm nhóm học tập</span>
          </h2>
